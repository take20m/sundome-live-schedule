...
<p>サンドーム福井でよくライブをやっているけれど、今日は誰のライブなのか、チケットの抽選期間に気づけていたら行きたかったのに、と感じたことが何度かあり、このサイトを作りました。会場公式・アーティスト公式・ファンクラブ・プレイガイドに散らばる情報を毎日集めて 1 ページにまとめ、そこに運営者が調べたガイドを足しています。</p>
